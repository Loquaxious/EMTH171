function [V_SIspill] = caseStudy2Model(P_w, P_geo)
%caseStudy2Model Performs Eulers Method on the equations given for the case
%study 
%   Pretty much the same as task 1 just in a function
